...
(define-public aws-c-common
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0hrmhm29zkbrqx5vgwsz2bl3bscw516ayvgs9vcxgw97h6pn5xad"))))
...
(define-public aws-c-event-stream
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r5zdm4plg5z03saamjwlcvksbs19n0pyglwh33crw16l7acw60n"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-cal
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jl8d5b7w49db2gy0kcqw8piszm7d3qydbb5zy4b43plhyj74cmg"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-sdkutils
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04z328yq2zyxm11shsmcqw8bn18bfqcnhw0gbfmnl7sb7mlragsf"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-http
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0kndpwkqcmnfyx7zalgig8pjlqml740wabdik4wq71c42vkw9v9b"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-compression
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "14v08bnghms98w7gswvzm51w5w49a2rsq6181fxjpq7k2x795nay"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-auth
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08glhz8v4cz1g6gpmwyfd0037pv1vxcks4vq40id5xij1n1jr7f8"))
              (patches
               (search-patches
...
(define-public aws-c-s3
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "14yfan51lqslkw91c0gd6ygwpmjr72l3xx6kczy1dkc18i3gdif5"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
...
(define-public aws-c-mqtt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "10cib98hn6xmd22m76jssla26fs3dd6gc70172h2vdnyfiyipydi"))))
    (build-system cmake-build-system)
    (arguments
     '(#:configure-flags
       (list "-DBUILD_SHARED_LIBS=ON"
